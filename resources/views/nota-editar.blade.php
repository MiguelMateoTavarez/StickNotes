...
<div class="container">
    ...
    <form method="POST" action="{{url('nota/{$note->id}')}}">
        ...
        <div class="mb-3">
            ...
            <input name="title" type="text" class="form-control" value="{{ old('title', $note->title) }}">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Contenido</label>
            <textarea name="content" class="form-control" rows="3">{{ old('content', $note->content) }}</textarea>
        </div>
